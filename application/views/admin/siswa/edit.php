                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Ketikkan nama lengkap ..." value="<?= $siswa->nama ?>">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nis" id="nis" class="form-control" placeholder="Ketikkan nis ..." value="<?= $siswa->nis ?>">
                                                ...
                                                <div class=" col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="kelas" id="kelas" class="form-control" placeholder="Ketikkan kelas ..." value="<?= $siswa->kelas ?>">
                                                ...
                                                <div class=" col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nik" id="nik" class="form-control" placeholder="Ketikkan nik ..." value="<?= $siswa->nik ?>">
                                                ...
                                                <div class=" col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" placeholder="Ketikkan Tempat Lahir ..." value="<?= $siswa->tempat_lahir ?>">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" placeholder="Ketikkan Tanggal Lahir ..." value="<?= $siswa->tgl_lahir ?>">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Ketikkan Alamat ..." value="<?= $siswa->alamat ?>">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="nama_jalan">Nama Jalan</label>
                                                        <input type="text" name="nama_jalan" id="nama_jalan" class="form-control" placeholder="Ketikkan Nama Jalan ..." value="<?= $siswa->nama_jalan ?>">
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <label for="rt">RT</label>
                                                        <input type="number" name="rt" id="rt" class="form-control" placeholder="Ketikkan RT ..." value="<?= $siswa->rt ?>">
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <label for="rw">RW</label>
                                                        <input type="number" name="rw" id="rw" class="form-control" placeholder="Ketikkan RW ..." value="<?= $siswa->rw ?>">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="telp" id="telp" class="form-control" placeholder="Ketikkan Nomor HP ..." value="<?= $siswa->telp ?>">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="email">Email</label>
                                                        <input type="email" name="email" id="email" class="form-control" placeholder="Ketikkan Email ..." value="<?= $siswa->email ?>">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="urutan_anak" id="urutan_anak" class="form-control" placeholder="Ketikkan Anak Ke ..." value="<?= $siswa->urutan_anak ?>">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="nama_ayah" id="nama_ayah" class="form-control" placeholder="Ketikkan Nama Ayah ..." value="<?= $siswa->nama_ayah ?>">
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="nama_ibu" id="nama_ibu" class="form-control" placeholder="Ketikkan Nama Ibu ..." value="<?= $siswa->nama_ibu ?>">
                                                            </div>
                                                            <div class="form-group">
